...
abstract class VectorNorm {
    ...
    /**
     * Returns a factor to scale magnitude and distance values to the range of
     * the vector components of dimensionality n. This is prim. used for scaling
     * color distances (n = 3). E.g., if components are distributed in [0,255],
     * the distances multiplied by this factor should again be in [0,255].
     *
     * @param n
     * @return
     */
