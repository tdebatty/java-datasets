...
/**
 * Represents a single scale level. Just a special kind of FloatProcessor with
 * some extra fields and methods.
 */
class ScaleLevel extends FloatProcessor {	// TODO: make IJ independent, use only float arrays
